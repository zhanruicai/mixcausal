...
arma::mat generate_dummy_Categorical(arma::vec x){
  arma::vec a = unique(x);
  int n = x.size(), numCat = a.size(), i, j, tmp = 999999;
  arma::mat dummy = zeros(n, numCat-1);
  for(i=0; i<n; i++){
...
arma::mat generate_dummy_Ordinal(arma::vec x){
  arma::vec a = unique(x);
...
double OrdinalOrdinal(arma::vec x, arma::vec y)
{
  ...
  arma::mat m2 = generate_dummy_Ordinal(y);
...
double CategoricalCategorical(arma::vec x, arma::vec y)
{
  ...
  arma::mat m2 = generate_dummy_Categorical(y);
  int n1 = m1.n_cols, n2 = m2.n_cols,i, j;
  double xnew=0.0;
  for(i=0; i<n1; i++){
    for(j=0; j<n2; j++){
...
double CategoricalOrdinal(arma::vec x, arma::vec y)
{
  arma::mat m1 = generate_dummy_Categorical(x);
  arma::mat m2 = generate_dummy_Ordinal(y);
  int n1 = m1.n_cols, n2 = m2.n_cols,i, j;
...
double OrdinalContiuous(arma::vec x, arma::vec y)
{
  arma::mat m1 = generate_dummy_Ordinal(x);
  int n1 = m1.n_cols,i;
  double xnew=0.0;
...
double CategoricalContiuous(arma::vec x, arma::vec y)
{
  arma::mat m1 = generate_dummy_Categorical(x);
  int n1 = m1.n_cols,i;
  double xnew=0.0;
...
double CategoricalBinary(arma::vec x, arma::vec y)
{
  arma::mat m1 = generate_dummy_Categorical(x);
  int n1 = m1.n_cols,i;
  double xnew=0.0;
...
double OrdinallBinary(arma::vec x, arma::vec y)
{
  arma::mat m1 = generate_dummy_Ordinal(x);
  int n1 = m1.n_cols,i;
  double xnew=0.0, a;
